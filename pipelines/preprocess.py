...
if __name__ == "__main__":
    ...
    subprocess.check_call(
        "cp -r /opt/ml/processing/sagemaker-intel/dataset/train/* /opt/ml/processing/dataset/train",
        shell=True,
    )
    subprocess.check_call(
        "cp -r /opt/ml/processing/sagemaker-intel/dataset/test/* /opt/ml/processing/dataset/test",
        shell=True,
    )
